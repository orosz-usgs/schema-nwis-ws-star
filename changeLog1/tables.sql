...
(nwis_host_nm                   varchar2(14 byte)
,db_no                          varchar2(2 byte)
,agency_cd                      varchar2(5 byte)
,site_no                        varchar2(15 byte)
,station_nm                     varchar2(50 byte)
,station_ix                     varchar2(50 byte)
,lat_va                         varchar2(11 byte)
,long_va                        varchar2(12 byte)
,dec_lat_va                     varchar2(40 byte)
,dec_long_va                    varchar2(40 byte)
,coord_meth_cd                  varchar2(1 byte)
,coord_acy_cd                   varchar2(1 byte)
,coord_datum_cd                 varchar2(10 byte)
,district_cd                    varchar2(3 byte)
,land_net_ds                    varchar2(23 byte)
,map_nm                         varchar2(20 byte)
,country_cd                     varchar2(2 byte)
,state_cd                       varchar2(2 byte)
,county_cd                      varchar2(3 byte)
,mcd_cd                         varchar2(5 byte)
,map_scale_fc                   varchar2(7 byte)
,alt_va                         varchar2(8 byte)
,alt_meth_cd                    varchar2(1 byte)
,alt_acy_va                     varchar2(3 byte)
,alt_datum_cd                   varchar2(10 byte)
,huc_cd                         varchar2(16 byte)
,agency_use_cd                  varchar2(1 byte)
,basin_cd                       varchar2(2 byte)
,site_tp_cd                     varchar2(7 byte)
,topo_cd                        varchar2(1 byte)
,data_types_cd                  varchar2(30 byte)
,instruments_cd                 varchar2(30 byte)
,site_rmks_tx                   varchar2(50 byte)
,inventory_dt                   varchar2(8 byte)
,drain_area_va                  varchar2(8 byte)
,contrib_drain_area_va          varchar2(8 byte)
,tz_cd                          varchar2(6 byte)
,local_time_fg                  varchar2(1 byte)
,gw_file_cd                     varchar2(30 byte)
,construction_dt                varchar2(8 byte)
,reliability_cd                 varchar2(1 byte)
,aqfr_cd                        varchar2(8 byte)
,nat_aqfr_cd                    varchar2(10 byte)
,site_use_1_cd                  varchar2(1 byte)
,site_use_2_cd                  varchar2(1 byte)
,site_use_3_cd                  varchar2(1 byte)
,water_use_1_cd                 varchar2(1 byte)
,water_use_2_cd                 varchar2(1 byte)
,water_use_3_cd                 varchar2(1 byte)
,nat_water_use_cd               varchar2(2 byte)
,aqfr_type_cd                   varchar2(1 byte)
,well_depth_va                  varchar2(8 byte)
,hole_depth_va                  varchar2(8 byte)
,depth_src_cd                   varchar2(1 byte)
,project_no                     varchar2(12 byte)
,site_web_cd                    varchar2(1 byte)
,site_cn                        varchar2(104 byte)
,site_cr                        timestamp(6)        not null
,site_mn                        varchar2(104 byte)
,site_md                        timestamp(6)        not null
,deprecated_fg                  varchar2(1 byte)
