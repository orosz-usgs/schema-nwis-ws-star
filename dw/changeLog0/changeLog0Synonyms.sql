...
create or replace synonym lu_tz for lu_tz@nwq_stg.er.usgs.gov;
...
create or replace synonym lu_parm_seq_grp_cd for lu_parm_seq_grp_cd@nwq_stg.er.usgs.gov;
...
create or replace synonym fxd for fxd@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym fxd;

--changeset drsteini:0SchemaSynonymsBG
create or replace synonym tu for tu@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym tu;

--changeset drsteini:0SchemaSynonymsBH
create or replace synonym nwis_wqx_medium_cd for nwis_wqx_medium_cd@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym nwis_wqx_medium_cd;

--changeset drsteini:0SchemaSynonymsBI
create or replace synonym body_part for body_part@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym body_part;

--changeset drsteini:0SchemaSynonymsBJ
create or replace synonym proto_org for proto_org@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym proto_org;

--changeset drsteini:0SchemaSynonymsBK
create or replace synonym meth for meth@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym meth;

--changeset drsteini:0SchemaSynonymsBL
create or replace synonym z_cit_meth for z_cit_meth@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym z_cit_meth;

--changeset drsteini:0SchemaSynonymsBM
create or replace synonym nwis_wqx_rpt_lev_cd for nwis_wqx_rpt_lev_cd@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym nwis_wqx_rpt_lev_cd;

--changeset drsteini:0SchemaSynonymsBN
create or replace synonym val_qual_cd for val_qual_cd@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym val_qual_cd;

--changeset drsteini:0SchemaSynonymsBO
create or replace synonym hyd_event_cd for hyd_event_cd@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym hyd_event_cd;

--changeset drsteini:0SchemaSynonymsBP
create or replace synonym hyd_cond_cd for hyd_cond_cd@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym hyd_cond_cd;

--changeset drsteini:0SchemaSynonymsBQ
create or replace synonym nwis_district_cds_by_host for nwis_district_cds_by_host@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym nwis_district_cds_by_host;

--changeset drsteini:0SchemaSynonymsBR
create or replace synonym aqfr for aqfr@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym aqfr;

--changeset drsteini:0SchemaSynonymsBS
create or replace synonym stage_country for country@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym stage_country;

--changeset drsteini:0SchemaSynonymsBT
create or replace synonym stage_county for county@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym stage_county;

--changeset drsteini:0SchemaSynonymsBU
create or replace synonym stage_state for state@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym stage_state;

--changeset drsteini:0SchemaSynonymsBV
create or replace synonym site_tp for site_tp@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym site_tp;

--changeset drsteini:0SchemaSynonymsBW
create or replace synonym nwis_misc_lookups for nwis_misc_lookups@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym nwis_misc_lookups;

--changeset drsteini:0SchemaSynonymsBX
create or replace synonym nat_aqfr for nat_aqfr@nwis_ws_stg.er.usgs.gov;
--rollback drop synonym nat_aqfr;

--changeset drsteini:0SchemaSynonymsBY
create or replace synonym state_fips for state_fips@nwis_ws_stg.er.usgs.gov;
...
--changeset drsteini:0SchemaSynonymsCB
create or replace synonym wqp_nemi_nwis_crosswalk for wqp_core.wqp_nemi_nwis_crosswalk;
