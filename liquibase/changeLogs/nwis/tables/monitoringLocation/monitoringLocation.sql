...
(monitoring_location_id                  integer generated by default as identity (start with 1)
...
,latitude_longitude_accuracy_value       character varying (12)
,latitude_longitude_accuracy_unit        character varying (12)
...
,constraint monitoring_location_ak unique (agency_cd, site_identification_number, site_id)
)
