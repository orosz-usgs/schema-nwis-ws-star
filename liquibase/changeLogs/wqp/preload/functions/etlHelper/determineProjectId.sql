create or replace function ${NWIS_WS_STAR_SCHEMA_NAME}.determine_project_id
     (p_site_no           in ${NWIS_WS_STAR_SCHEMA_NAME}.nawqa_sites.site_no%type,
      p_50280_value       in ${NWIS_WS_STAR_SCHEMA_NAME}.qw_result.result_unrnd_va%type,
